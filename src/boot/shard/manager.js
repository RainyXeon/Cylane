...
class Manager extends Client {
  constructor() {
    super({
      ...
      intents: require("../../plugins/config.js").features.MESSAGE_CONTENT
        .enable
        ? [
    ...
    if (
      ...
      return this.logger.error(
        "You cannot use more than 1 lavalink in AUTOFIX features",
      );
