...
module.exports = { 
    ...
    run: async (client, message, args, language, prefix) => {
            ...
            if (!value) {
                ...
                if (isNaN(value)) return message.channel.send(`${client.i18n.get(language, "music", "queue_notnumber")}`);
                if (value > pagesNum) return message.channel.send(`${client.i18n.get(language, "music", "queue_page_notfound", {
                    page: pagesNum,
                })}`);
