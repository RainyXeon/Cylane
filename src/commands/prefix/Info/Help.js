...
module.exports = {
  ...
  run: async (client, message, args, language, prefix) => {
    ...
    const embed = new EmbedBuilder()
      .setAuthor({
        name: `${message.guild.members.me.displayName} Help Command! [PREFIX]`,
        iconURL: message.guild.iconURL({ dynamic: true }),
      })
      .setDescription(
        stripIndents`${client.i18n.get(language, "help", "welcome", {
          bot: message.guild.members.me.displayName,
            ...
            ${client.i18n.get(language, "help", "ver", {
              botver: require("../../../../package.json").version,
            })}
            ${client.i18n.get(language, "help", "djs", {
              djsver: require("../../../../package.json").dependencies[
                "discord.js"
              ],
            })}
      ...
      .setColor(client.color)
      .setFooter({
        text: `© ${message.guild.members.me.displayName} | Total Commands: ${client.commands.size}`,
